document.addEventListener('DOMContentLoaded', () => {
  ...
  if (postContentContainer && postSlug) {
      ...
      .then(posts => {
        ...
        if (post) {
          ...
          postContentContainer.innerHTML = `
            ...
            <img src="${post.image}" alt="" class="post-full__image">
    ...
    postContentContainer.innerHTML = '<p>No post specified or content area not found.</p>';
  }
});
